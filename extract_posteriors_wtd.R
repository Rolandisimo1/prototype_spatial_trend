...
run_model("white-tailed_deer_v2b_national_scalar", is_ecoregion = FALSE)
run_model("white-tailed_deer_v2b_ecoregion",       is_ecoregion = TRUE,
          caveat = paste("Trend params converged (all 12 at R-hat <= 1.0118, incl. every",
                         "year_region and sigma_region); the FIT as a whole did not: 32 gated",
                         "params exceed 1.1, ALL of them CAR fields (17 MCMT_effect, 15",
                         "link_occ_intercept), cells 855-907. Trend numbers here are usable;",
                         "the CAR intercept field and MCMT SVC surface are NOT. NB the failing",
                         "patch shares 11 of 12 cells with bobcat_v2b_ecoregion -- a grid",
                         "property, not a species-specific data problem."))
