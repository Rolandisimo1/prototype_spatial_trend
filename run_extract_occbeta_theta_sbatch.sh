#!/usr/bin/env bash
#SBATCH --job-name=extract_occtheta
#SBATCH --partition=compute
#SBATCH --qos=normal
#SBATCH --ntasks=1
#SBATCH --mem=64G
#SBATCH --time=04:00:00
#SBATCH --output=/home/rwkays/extract_occtheta_%j.log
#SBATCH --error=/home/rwkays/extract_occtheta_%j.log
...
"$RS" extract_occbeta_theta_all.R
