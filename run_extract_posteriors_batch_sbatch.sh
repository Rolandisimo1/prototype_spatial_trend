#!/usr/bin/env bash
#SBATCH --job-name=extract_post_batch
#SBATCH --partition=compute
#SBATCH --qos=normal
#SBATCH --ntasks=1
#SBATCH --mem=64G
#SBATCH --time=03:00:00
#SBATCH --output=/home/rwkays/extract_post_batch_%j.log
#SBATCH --error=/home/rwkays/extract_post_batch_%j.log
...
"$RS" extract_posteriors_batch.R
RC=$?; echo "extract exit: $RC"
echo "--- CAR diagnostic ---"
"$RS" diagnose_bobcat_v2b_ecoregion_car.R
echo "diag exit: $?  end: $(date)"; exit $RC
